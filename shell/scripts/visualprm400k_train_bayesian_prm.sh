...
BELIEF_BETA_KL=${BELIEF_BETA_KL:-0.0}
...
BAYESIAN_KEEP_ENSEMBLE_HEAD_IDX=${BAYESIAN_KEEP_ENSEMBLE_HEAD_IDX:-0}
...
echo "BAYESIAN_REINIT_OTHER_ENSEMBLE_HEADS: ${BAYESIAN_REINIT_OTHER_ENSEMBLE_HEADS}"
echo "BAYESIAN_KEEP_ENSEMBLE_HEAD_IDX: ${BAYESIAN_KEEP_ENSEMBLE_HEAD_IDX}"
...
python -m torch.distributed.run \
  ...
  --bayesian_reinit_other_ensemble_heads ${BAYESIAN_REINIT_OTHER_ENSEMBLE_HEADS} \
  --bayesian_keep_ensemble_head_idx ${BAYESIAN_KEEP_ENSEMBLE_HEAD_IDX} \
